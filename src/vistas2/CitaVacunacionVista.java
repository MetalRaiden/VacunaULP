...
//        cabecera();
        ...
        cargarDNIsCiudadanos();
        cargarNroSerieDosis();
        cargarCentrosVacunacion();
    }
    ...
    private void initComponents() {
        ...
        jCB_dnis_ciudadanos = new javax.swing.JComboBox<>();
        jCB_nSerie_dosis = new javax.swing.JComboBox<>();
        jCB_id_centroVacunacion = new javax.swing.JComboBox<>();
        jLabel16 = new javax.swing.JLabel();
        jCB_hora_vacunacion2 = new javax.swing.JComboBox<>();
        jDCFechaHoraVac2 = new com.toedter.calendar.JDateChooser();
        ...
        jCB_dnis_ciudadanos.setBackground(new java.awt.Color(137, 161, 209));
        jCB_dnis_ciudadanos.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        jCB_dnis_ciudadanos.setForeground(new java.awt.Color(59, 66, 109));
        jCB_dnis_ciudadanos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DNI Ciudadano" }));
        jCB_dnis_ciudadanos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCB_dnis_ciudadanosActionPerformed(evt);
            }
        });

        jCB_nSerie_dosis.setBackground(new java.awt.Color(137, 161, 209));
        jCB_nSerie_dosis.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        jCB_nSerie_dosis.setForeground(new java.awt.Color(59, 66, 109));
        jCB_nSerie_dosis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "N° Serie Dosis" }));
        jCB_nSerie_dosis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCB_nSerie_dosisActionPerformed(evt);
            }
        });

        jCB_id_centroVacunacion.setBackground(new java.awt.Color(137, 161, 209));
        jCB_id_centroVacunacion.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        jCB_id_centroVacunacion.setForeground(new java.awt.Color(59, 66, 109));
        jCB_id_centroVacunacion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID Centro Vacunación" }));
        jCB_id_centroVacunacion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCB_id_centroVacunacionActionPerformed(evt);
            }
        });

        jLabel16.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(59, 66, 109));
        jLabel16.setText("Fecha y Hora Vacunación:");

        jCB_hora_vacunacion2.setBackground(new java.awt.Color(137, 161, 209));
        jCB_hora_vacunacion2.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        jCB_hora_vacunacion2.setForeground(new java.awt.Color(59, 66, 109));
        jCB_hora_vacunacion2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Hora" }));
        jCB_hora_vacunacion2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCB_hora_vacunacion2ActionPerformed(evt);
            }
        });

        jDCFechaHoraVac2.setBackground(new java.awt.Color(137, 161, 209));
        jDCFechaHoraVac2.setForeground(new java.awt.Color(59, 66, 109));
        jDCFechaHoraVac2.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jCB_id_centroVacunacion, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jCB_nSerie_dosis, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jCB_dnis_ciudadanos, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jDCFechaHoraCita, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
                            .addComponent(jDCFechaHoraVac2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE))
                        .addGap(32, 32, 32)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jCB_hora_vacunacion2, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addComponent(jCB_nSerie_dosis, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(jCB_id_centroVacunacion, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jDCFechaHoraVac2, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jCB_hora_vacunacion2, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(112, 112, 112))))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jTCodCita, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jCB_dnis_ciudadanos, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jTable_citaVacunacion_tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo Cita", "DNI Ciudadano", "Fecha y Hora Cita", "Nro Serie Dosis", "ID Centro Vacunacion", "Fecha y Hora Vacunacion"
            }
        ));
    ...
    private void jTable_citaVacunacion_tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_citaVacunacion_tablaMouseClicked
        if (evt.getClickCount() == 1) { // Asegura que se haya hecho un solo clic
            ...
            if (row != -1) {
                ...
                int nroSerieDosis = (int) jTable_citaVacunacion_tabla.getValueAt(row, 3);
                int idCentroVacunacion = (int) jTable_citaVacunacion_tabla.getValueAt(row, 4);
                String fechaHoraVacunacion = jTable_citaVacunacion_tabla.getValueAt(row, 5).toString();

                // Llena los JComboBox con los valores obtenidos
                jTCodCita.setText(Integer.toString(codCita));
                jCB_dnis_ciudadanos.setSelectedItem(Integer.toString(dniCiudadano)); // Usar setSelectedItem para seleccionar un valor en el JComboBox
                jCB_nSerie_dosis.setSelectedItem(Integer.toString(nroSerieDosis));
                jCB_id_centroVacunacion.setSelectedItem(Integer.toString(idCentroVacunacion));
    ...
    private void jBAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAgregarActionPerformed
        ...
        if (!codCita.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Para agregar una cita nueva por favor deje el código de cita vacío");
        } else {
            // Obtener el DNI del ciudadano seleccionado en el JComboBox
            String dniCiudadanoStr = (String) jCB_dnis_ciudadanos.getSelectedItem();
            if (dniCiudadanoStr == null || dniCiudadanoStr.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Por favor, seleccione un DNI de ciudadano válido");
            } else {
                int DNIc = Integer.parseInt(dniCiudadanoStr);
                ...
                if (ciudadano == null) {
                    ...
                    // Obtener la fecha y hora de la cita del JDateChooser
                    Date fechaHoraCitaDate = (Date) jDCFechaHoraCita.getDate();
                    if (fechaHoraCitaDate == null) {
                        JOptionPane.showMessageDialog(this, "Por favor, seleccione una fecha y hora de cita válida");
                    } else {
                        // Obtener el ID del centro de vacunación seleccionado en el JComboBox
                        String idCentroStr = (String) jCB_id_centroVacunacion.getSelectedItem();
                        if (idCentroStr == null || idCentroStr.isEmpty()) {
                            JOptionPane.showMessageDialog(this, "Por favor, seleccione un ID de centro de vacunación válido");
                        } else {
                            ...
                            if (centroVacunacion == null) {
                                JOptionPane.showMessageDialog(this, "No existe un Centro de Vacunación registrado con ese ID");
                            } else {
                                // Obtener el número de serie de dosis seleccionado en el JComboBox
                                String nroDosisStr = (String) jCB_nSerie_dosis.getSelectedItem();
                                if (nroDosisStr == null || nroDosisStr.isEmpty()) {
                                    JOptionPane.showMessageDialog(this, "Por favor, seleccione un número de serie de dosis válido");
                                } else {
                                    int nroDosis = Integer.parseInt(nroDosisStr);
                                    Vacuna vacuna = vacunaData.obtenerVacunaPorNroSerie(nroDosis);
                                    if (vacuna == null) {
                                        JOptionPane.showMessageDialog(this, "No existe una vacuna con ese número de serie de dosis");
                                    } else {
                                        int codCita2 = 0; // Otra lógica para generar el código de cita
                                        String fechaHoraCita = fechaHoraCitaDate.toString(); // Convierte Date a String si es necesario
                                        citaVacunacion cita = new citaVacunacion(codCita2, ciudadano, fechaHoraCita, centroVacunacion, null, vacuna);
...
//            citaVacunacion citaVac = citaData.BuscarCitaPorCodCita(cod);
//            if (citaVac != null) {
//                int DNIc = Integer.parseInt(jCB_dnis_ciudadanos.getText());
//                Ciudadano ciudadano = ciudadanoData.buscarCiudadanoPorDNI(DNIc);
//                if (ciudadano == null) {
//                    JOptionPane.showMessageDialog(this, "Ciudadano no registrado con ese DNI");
//                } else {
//                    String fechaHoraCita = jDCFechaHoraCita.getDate().toString();
//                    int IDcentro = Integer.parseInt(jCB_id_centroVacunacion.getText());
//                    CentroVacunacion centroVacunacion = centroVacunacionData.obtenerCentroVacunacionPorId(IDcentro);
//                    if (centroVacunacion == null) {
...
//                        }
//                        int nroDosis = Integer.parseInt(jCB_nSerie_dosis.getText());
//                        Vacuna vacuna = vacunaData.obtenerVacunaPorNroSerie(nroDosis);
//                        if (vacuna == null) {
...
//        }
        ...
        if (!codCita.isEmpty()) {
            ...
            if (citaVac != null) {
                int DNIc = Integer.parseInt(jCB_dnis_ciudadanos.getSelectedItem().toString());
                Ciudadano ciudadano = ciudadanoData.buscarCiudadanoPorDNI(DNIc);
                ...
                if (ciudadano == null) {
                    ...
                    String fechaHoraCita = jDCFechaHoraCita.getDate().toString();
                    int IDcentro = Integer.parseInt(jCB_id_centroVacunacion.getSelectedItem().toString());
                    CentroVacunacion centroVacunacion = centroVacunacionData.obtenerCentroVacunacionPorId(IDcentro);

                    if (centroVacunacion == null) {
                        JOptionPane.showMessageDialog(this, "No existe un Centro de Vacunacion registrado con ese ID");
                    } else {
                        LocalDateTime localDateTime = LocalDateTime.now(); // Obtener la fecha y hora actual

                        int nroDosis = Integer.parseInt(jCB_nSerie_dosis.getSelectedItem().toString());
                        Vacuna vacuna = vacunaData.obtenerVacunaPorNroSerie(nroDosis);

                        if (vacuna == null) {
                            JOptionPane.showMessageDialog(this, "No existe una vacuna con ese número de serie");
                        } else {
                            citaVac.setPersona(ciudadano);
                            citaVac.setFechaHoraCita(fechaHoraCita);
                            citaVac.setCentroVacunacion(centroVacunacion);
                            citaVac.setFechaHoraVacunacion(localDateTime);
                            citaVac.setMedida(vacuna);

                            citaData.ModificarCita(citaVac);
                            limpiarCampos();
                            cargarTabla();
                        }
                    }
    ...
    private void jCB_dnis_ciudadanosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCB_dnis_ciudadanosActionPerformed
        String laboratorioSeleccionado = (String) jCB_dnis_ciudadanos.getSelectedItem();  //// Evento que se ejecuta al seleccionar un laboratorio en el ComboBox padre

    }//GEN-LAST:event_jCB_dnis_ciudadanosActionPerformed

    private void jCB_nSerie_dosisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCB_nSerie_dosisActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jCB_nSerie_dosisActionPerformed

    private void jCB_id_centroVacunacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCB_id_centroVacunacionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jCB_id_centroVacunacionActionPerformed

    private void jCB_hora_vacunacion2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCB_hora_vacunacion2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jCB_hora_vacunacion2ActionPerformed
...
//            citaVacunacion citaVac = citaData.BuscarCitaPorCodCita(cod);
//            if (citaVac != null) {
//                jCB_dnis_ciudadanos.setText(Integer.toString(citaVac.getPersona().getDNI()));
...
//                }
//                jCB_id_centroVacunacion.setText(Integer.toString(citaVac.getCentroVacunacion().getIDcentro()));
//                jCB_nSerie_dosis.setText(Integer.toString(citaVac.getMedida().getNroSerieDosis()));
//            } else {
//                JOptionPane.showMessageDialog(this, "No existe una cita con ese código de cita");
//            }
//        } else if (codCita.isEmpty()) {
...
//    }
    ...
    public javax.swing.JComboBox<String> jCB_dnis_ciudadanos;
    ...
    public javax.swing.JComboBox<String> jCB_hora_vacunacion2;
    public javax.swing.JComboBox<String> jCB_id_centroVacunacion;
    public javax.swing.JComboBox<String> jCB_nSerie_dosis;
    ...
    private com.toedter.calendar.JDateChooser jDCFechaHoraVac2;
...
//    }
    private void limpiarCampos() {
        Date date = null;
        jTCodCita.setText("");
        jCB_nSerie_dosis.setSelectedIndex(-1);
        jCB_dnis_ciudadanos.setSelectedIndex(-1);
        jCB_id_centroVacunacion.setSelectedIndex(-1);
...
//    }
    ...
    private void cargarDNIsCiudadanos() {
        DefaultComboBoxModel<String> model = new DefaultComboBoxModel<>();
        List<Ciudadano> ciudadanos = ciudadanoData.listarCiudadanos(null);

        for (Ciudadano ciudadano : ciudadanos) {
            model.addElement(String.valueOf(ciudadano.getDNI()));
        }

        jCB_dnis_ciudadanos.setModel(model);
    }

    public  void cargarNroSerieDosis() {
        DefaultComboBoxModel<String> model = new DefaultComboBoxModel<>();
        List<Vacuna> vacunas = vacunaData.listarVacunas();

        jCB_nSerie_dosis.removeAllItems();
        
        for (Vacuna vacuna : vacunas) {
            model.addElement(String.valueOf(vacuna.getNroSerieDosis()));
        }

        jCB_nSerie_dosis.setModel(model);
        
    }
    
    public void cargarCentrosVacunacion() {
    DefaultComboBoxModel<String> model = new DefaultComboBoxModel<>();
    List<CentroVacunacion> centros = centroVacunacionData.listarCentros();

    jCB_id_centroVacunacion.removeAllItems();
    
    for (CentroVacunacion centro : centros) {
        model.addElement(String.valueOf(centro.getIDcentro()));
    }

    jCB_id_centroVacunacion.setModel(model);
}
